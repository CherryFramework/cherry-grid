...
class Cherry_Grid_Shortcode {
	...
	public function get_grid_style( $class, $template, $atts ) {
		...
		require_once( CHERRY_GRID_DIR . 'public/includes/class-cherry-grid-css-parser.php' );
	...
	function setup_template_data( $atts ) {
		...
		require_once( CHERRY_GRID_DIR . 'public/includes/class-cherry-grid-shortcode-callbacks.php' );
